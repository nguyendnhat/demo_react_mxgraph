...
// PREPROCESSOR-REMOVE-END
	...
	// mxClient.include('/mxgraphEditor/js/Init.js');
    // mxClient.include('/mxgraphEditor/deflate/pako.min.js');
    // mxClient.include('/mxgraphEditor/deflate/base64.js');
    // mxClient.include('/mxgraphEditor/jscolor/jscolor.js');
    // mxClient.include('/mxgraphEditor/sanitizer/sanitizer.min.js');
    // mxClient.include('/mxgraphEditor/js/EditorUi.js');
    // mxClient.include('/mxgraphEditor/js/Editor.js');
    // mxClient.include('/mxgraphEditor/js/Sidebar.js');
    // mxClient.include('/mxgraphEditor/js/Graph.js');
    // mxClient.include('/mxgraphEditor/js/Format.js');
    // mxClient.include('/mxgraphEditor/js/Shapes.js');
    // mxClient.include('/mxgraphEditor/js/Actions.js');
    // mxClient.include('/mxgraphEditor/js/Menus.js');
    // mxClient.include('/mxgraphEditor/js/Toolbar.js');
    // mxClient.include('/mxgraphEditor/js/Dialogs.js');
// PREPROCESSOR-REMOVE-START
}
// PREPROCESSOR-REMOVE-END
